...
int main()
{
    ...
    // 1. задаём вершины
    float vertices[] = {
         0.5f,  0.5f, 0.0f,  // Точка 0: правый верхний угол
         0.5f, -0.5f, 0.0f,  // Точка 1: правый нижний угол
        -0.5f, -0.5f, 0.0f,  // Точка 2: левый нижний угол
        -0.5f,  0.5f, 0.0f   // Точка 3: левый верхний угол
    };
